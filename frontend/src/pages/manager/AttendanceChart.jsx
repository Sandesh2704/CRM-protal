...
//     // Test with a random date (for example: 2024-11-02)
//     const randomDate = new Date("2024-11-6");
//     const today = randomDate.toISOString().split("T")[0];
...
//                 `${process.env.REACT_APP_DOMAIN_URL}/attendanceManage/get-attendance/${parentId}/${year}/${month}`
//             );
...
//     // Highlight matched text within the username
...
//     // Filter staff data based on the query
...
//                     <div className='flex gap-4 w-fit justify-between items-center py-2 px-3 rounded border'>
//                         <input
//                             type="text"
//                             value={query}
...
//                             <Calendar
//                                 attendanceData={newAttendance[staff._id] || {}}
//                                 month={month}
//                                 year={year}
